...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate via the <b>POST /api/v1/auth/login</b> endpoint to get a Bearer token. Include it in the Authorization header as <code>Bearer {token}</code>.',
    ],
